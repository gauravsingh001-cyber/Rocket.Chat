...
- ([#38610](https://github.com/RocketChat/Rocket.Chat/pull/38610) by [@nazabucciarelli](https://github.com/nazabucciarelli)) Fixes Custom Sounds Contextualbar state and refresh behavior
...
- ([#38610](https://github.com/RocketChat/Rocket.Chat/pull/38610) by [@nazabucciarelli](https://github.com/nazabucciarelli)) Adds new `custom-sounds.getOne` REST endpoint to retrieve a single custom sound by `_id` and updates client to consume it.
...
- ([#38531](https://github.com/RocketChat/Rocket.Chat/pull/38531) by [@nazabucciarelli](https://github.com/nazabucciarelli)) Fixes a cross-resource access issue that allowed users to retrieve emojis from the Custom Sounds endpoint and sounds from the Custom Emojis endpoint when using the FileSystem storage mode.
...
- ([#38954](https://github.com/RocketChat/Rocket.Chat/pull/38954) by [@nazabucciarelli](https://github.com/nazabucciarelli)) Fixes reactivity of Custom Sounds and Custom Emojis storage settings
